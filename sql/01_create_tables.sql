...
CREATE TABLE IF NOT EXISTS t12_cancelacion (
    ...
    T06_idTramoVuelo INT NOT NULL COMMENT 'Vuelo cancelado',
    ...
    FOREIGN KEY (T06_idTramoVuelo) REFERENCES t06_vuelo_programado(T06_idTramoVuelo)
        ON DELETE CASCADE ON UPDATE CASCADE,

    INDEX idx_canc_vuelo (T06_idTramoVuelo),
